...
public class BattleSystem {
	...
	public void StatusOutput(ArrayList<BattleCharactor> charactors) {
		for (int i = 0; i < charactors.size(); i++) {
			System.out.println(charactors.get(i));
	...
	public void fightFinish(ArrayList<BattleCharactor> charactors) {
		...
		int heroCount=0;
		int enemyCount=0;
		for(BattleCharactor c : charactors){
			if(c instanceof Hero ==true){
				heroCount++;
		...
		else if(heroCount==0&&enemyCount==0){
